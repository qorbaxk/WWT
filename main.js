...
const getWeather = async () => {
  let local = `${nowWhere}`; //지역설정
  let url = new URL(
    `https://api.openweathermap.org/data/2.5/weather?&q=${local}&units=metric&appid=ef710ba10aec5ee8c5ce8f984a15dff0`
  );
